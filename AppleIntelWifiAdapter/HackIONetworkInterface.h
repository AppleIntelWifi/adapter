...
*/
    ...
    /**
     add by zxy, it is an export symbol but not contain in header files, modify this file add this function,
     it cause this project should compile with this version of sdk(10.11) unless you modify other version headers like what I have done.
     */
    bool setInterfaceSubType(uint type);
