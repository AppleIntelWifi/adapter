 ...
 */
struct ieee80211_regdomain *iwl_parse_nvm_mcc_info(IWLDevice *dev,
                                                   const struct iwl_cfg *cfg,
                                                   int num_of_ch,
                                                   __le32 *channels, u16 fw_mcc,
                                                   u16 geo_info, u16 cap);

/**
 * iwl_read_external_nvm - Reads external NVM from a file into nvm_sections
 */
int iwl_read_external_nvm(IWLTransport *trans, const char *nvm_file_name,
