...
class IWLIO {
 public:
  ...
  int iwlPollBit(u32 addr, u32 bits, u32 mask, int timeout);
  ...
  /*
   * UMAC periphery address space changed from 0xA00000 to 0xD00000 starting
   * from device family AX200. So peripheries used in families above and below
   * AX200 should go through iwl_..._umac_..._prph.
   */
