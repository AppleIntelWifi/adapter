...
int allocate_rxb(OSObject* target, void* arg0, void* arg1, void* arg2, void* arg3) {
...
restart:
    ...
    while(i != r) {
        ...
        IWL_INFO(trans, "Q %d: HW = %d, SW = %d (total: %d, used: %d, free: %d)\n", _rxq->id, r, i, _rxq->queue_size, _rxq->used_count, _rxq->free_count
                 );
